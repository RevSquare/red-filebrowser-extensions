...
class CropFileBrowserSite(sites.FileBrowserSite):
    ...
    def get_urls(self):
        ...
        urlpatterns.append(url(r'^crop/$', self.filebrowser_view(self.crop), name="fb_crop"))
        urlpatterns.append(url(r'^list_versions/$', self.filebrowser_view(self.list_versions), name="fb_list_versions"))
    ...
    def list_versions(self, request):
        ...
        return render(request, 'cropper/list.html', {
            'query': query,
            'fileobject': fileobject,
            'versions' : versions
        })
